 ...
 */
export function reposLoaded(repos) { //reposLoaded(repos, username)
  return {
 ...
 * @return {object} An action object with a type of LOAD_REPOS
 */
export function loadArticlesDetail() {
  return {
 ...
 * @return {object} An action object with a type of LOAD_REPOS
 */
export function articlesDetailLoaded(articlesDetail, articleId) {
  return {
 ...
 * @return {object}       An action object with a type of LOAD_REPOS_ERROR passing the error
 */
export function articlesDetailLoadingError(error) {
  return {
